...
def MainExpS(imgPath,stimPath, clock, kb, mywin, pains, painsFiles, subjectNum, subjPath, sessionNum, thisBlock, RatScaleOr):
    ...
    for i in range (0,nTrials):
        ...
        if ABin[i,0] == 2:
            ...
            Outcome[i] = np.random.choice([1,0], 1, p=[allPain['pPainRed'][i], 1 - allPain['pPainRed'][i]])
        elif ABin[i,0] == 3:
